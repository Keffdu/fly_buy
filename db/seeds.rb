...
p1 = Aircraft.create(airport_id: ap.sample, manufacturer: "Corben", model: "Baby Ace", hours: 30, description: "This is a fun single-seat tail wheel airplane, perfect for solo flights and cruising around in to build up your hours. There is no crazy gadgets to worry about in this plane, just focuses on the fundamentals and basic instrumentation. Max speed is this is roughly 100-110 mph, with a range of about 350mi. It's a real joy to fly!", image: "https://s3.eu-west-2.amazonaws.com/abpic-media-eu-production/pictures/full_size_0531/1807401-large.jpg", hourly_rate: 75)
...
p7 = Aircraft.create(airport_id: ap.sample, manufacturer: "Piper", model: "Arrow", hours: 42, description: "The Arrow may be a good choice for a pilot with little complex aircraft experience or one who does not fly often. It was designed to be an easy step up for pilots transitioning from a trainer to a single with retractable landing gear and controllable-pitch propeller.", image: "https://brantaero.com/wp-content/uploads/2021/03/Ext-1-1.jpg", hourly_rate: 130)

p8 = Aircraft.create(airport_id: ap.sample, manufacturer: "Piper", model: "Colt", hours: 60, description: "The Piper Colt is a great entry plane, it is one of our most used planes and is a great aircraft to start building your hours in. It has been well maintained and is a joy to fly", image: "https://www.planesales.com.au/Uploads/Listing/Normal/ID02428-6908-1-477-1961-Piper-Colt-Aircraft.jpeg", hourly_rate: 85)

p9 = Aircraft.create(airport_id: ap.sample, manufacturer: "Mooney", model: "M20", hours: 46, description: "An easy to fly, reliable aircraft. There is nothing super fancy about this aircraft but it allows for good fundamentals and great entry into flying.", image: "https://aviatorinsider.com/wp-content/uploads/2021/08/MooneyM20CMark21C-FGUQ.jpg", hourly_rate: 115)

p10 = Aircraft.create(airport_id: ap.sample, manufacturer: "Piper", model: "Archer", hours: 71, description: "A stable for general aviation, it's a reliable aircraft to build your flight hours and begin your journey towards becoming a pilot", image: "https://www.iowaflighttraining.com/wp-content/uploads/2015/11/ArcherII-Copy.jpg", hourly_rate: 90)

p11 = Aircraft.create(airport_id: ap.sample, manufacturer: "Piper", model: "PA-18 Super Cub", hours: 32, description: "A more intermediate flying experience, but will allow you to build some time with a tail wheel aircraft. This is a very popular model and frequently booked.", image: "https://cubcrafters.com/c/wp-content/uploads/2022/01/IMG_9435.jpeg", hourly_rate: 105)
...
p19 = Aircraft.create(airport_id: ap.sample, manufacturer: "Mooney", model: "M20", hours: 46, description: "An easy to fly, reliable aircraft. There is nothing super fancy about this aircraft but it allows for good fundamentals and great entry into flying.", image: "https://www.hangar67.com/photos/25146/5350eb8340.jpg", hourly_rate: 115)

p20 = Aircraft.create(airport_id: ap.sample, manufacturer: "Piper", model: "Archer", hours: 71, description: "A stable for general aviation, it's a reliable aircraft to build your flight hours and begin your journey towards becoming a pilot", image: "https://www.planesalesusa.com/Uploads/Listing/Normal/ID01582-9039-1-212-1978-Piper-Archer-II-Aircraft.jpeg", hourly_rate: 90)

p21 = Aircraft.create(airport_id: ap.sample, manufacturer: "Piper", model: "PA-18 Super Cub", hours: 32, description: "A more intermediate flying experience, but will allow you to build some time with a tail wheel aircraft. This is a very popular model and frequently booked.", image: "https://www.jaair.com/wp-content/uploads/2018/09/DSC_0011.jpg", hourly_rate: 105)
